...
### User-set vars...
IDIFF2_PATH='/media/khan/project/dfxml-master/python/idifference2.py'
PARSE_DFXML_PATH = '/media/khan/project/raw_images/parse_dfxml.py'
BLOCK_SIZE=512 # 512,4096,... use image drive block size
SECTOR_SIZE = 512
IMAGE_LIST=[    '/media/khan/CNIT523/project/first.img',
        '/media/khan/project/second.img',
        '/media/khan/project/third.img']
HAVE_TEMP_DFXML=True # True if you already have a temp.dfxml file (idiff output for images 1-2), otherwise False; saves time
### end User-set vars

def find_deleted_reconstruct(i1, i2):
    ...
    #parsing dfxml
    cmd='python3 '+PARSE_DFXML_PATH+' config.yaml '+'112021'
    print('Running: '+cmd)
    os.system(cmd)
